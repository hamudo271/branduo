...
const Pricing = () => {
  useSEO({
    title: '병의원 마케팅 요금 안내 | 개원 마케팅 패키지 & 병원마케팅회사 비용',
    description: '병의원 규모와 목표에 맞는 전용 마케팅 패키지. 개원 초기 부스터에서 로컬 시장 1위까지, 병원마케팅회사가 제안하는 합리적인 비용의 신환 유입 솔루션을 확인하세요.',
    keywords: '병원마케팅비용, 개원마케팅, 병원마케팅회사, 병의원마케팅패키지, 성형외과마케팅요금, 피부과마케팅비용',
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="space-y-32">
            ...
            <div>
              ...
              >
                {[
                  { title: "병의원 개원 마케팅 부스터", staff: "PM 1인 / 기획 1인 / 에디터 1인", period: "3개월 집중", features: ["온라인 기본 세팅 (네이버 지도, 블로그)", "지역 상권 타겟팅 메타 광고", "의료법 검토 리뷰 빌드업", "초기 환자 DB 확보 랜딩페이지", "환자 경험(PX) 동선 컨설팅"] },
                  { title: "로컬 병원마케팅 점유율 1위", staff: "메디컬 전문 마케터 2인 추가", period: "6개월 이상", features: ["경쟁 병원 대비 상위 노출 전략", "하이엔드 영상 매체(유튜브) 기획", "고관여 환자 유입 퍼포먼스 마케팅", "재방문 유도 CRM 자동화", "원내 상담 실장 화법 코칭"] },
                  { title: "병의원 프리미엄 지점 확장", staff: "브랜드 디렉터 전담", period: "연간 계약", features: ["VIP 환자 대상 프라이빗 브랜딩", "전 지점 통합 마케팅 가이드라인", "오가닉(자발적) 추천 바이럴 시스템", "언론 보도 및 학회 권위 PR", "전담 TF팀 배정 및 주간 리포팅"] },
                ].map((pkg, i) => (
                  <motion.div 
                    key={i} 
                    variants={fadeInUp}
